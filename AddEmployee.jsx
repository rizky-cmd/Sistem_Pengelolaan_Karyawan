	...
	return (
		<div className='d-flex flex-column align-items-center pt-4'>
			...
			<div className="col-12">
					<label form="inputName" className="form-label">Name</label>
				...
				<div className="col-12">
					<label form="inputSalary" className="form-label">Salary</label>
				...
				<div className="col-12 mb-3">
					<label className="form-label" form="inputGroupFile01">Select Image</label>
